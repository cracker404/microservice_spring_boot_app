...
/**
 * This is Image/file uploading service/class S3Repository there are two methods
 * for upload image and get the signed url of Particular image. We have used aws
 * s3 credential for aws Http api call.
 * 
...
public class S3Service
{
    ...
    */
   // @Async
   public String saveImageToS3(String id, MultipartFile file) throws UserException
   {
   ...
   public void deleteFileFromS3(String key) throws UserException
   {
      try{
         ...
         throw new UserException(117, new Object[]{"note image delete"+e.getMessage()}, e);
      }
   }
